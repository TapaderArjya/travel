  ...
  <section class="content-header">
    ...
    <tbody>
     ...
     <tr>
      ...
      <td>{{$item->id}}</td>
      <td><img src="{{asset('photo/'.$item->image)}}" alt="" style="height: 50px; border-radius: 50%;"></td>
      <td>{{$item->designation}}</td>
      <td>{{$item->message}}</td>
      <td>
        <a href="testimonial_editdata/{{$item->id}}" class="btn btn-info"><i class="fas fa-eye"></i></a>
      </td>

      <td>
        <a href="testimonial_deletedata/{{$item->id}}" class="btn btn-danger"><i class="fas fa-trash"></i></a>         
      </td>
