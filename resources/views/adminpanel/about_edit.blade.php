...
@section('main-container')
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
          <form action="{{url('about_updatedata')}}" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="row">
              <div class="col-md-12">
            ...
            <div class="card-body">
              ...
              <div class="form-group">
                ...
                <input type="file" class="form-control" id="image" placeholder="Browse Your Photo" name="image" onchange="readPimage(this)" >
              </div>
              
              <div class="form-group">
                <label for="inputDescription">Short Description</label>
                <textarea id="inputDescription" class="form-control" rows="4" name="short_desc" value="{{$users->short_desc}}"></textarea>
              </div>
