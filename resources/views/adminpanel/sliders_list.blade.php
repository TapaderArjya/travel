    ...
    <section class="content-header">
      <div class="container-fluid">
        ...
        <div class="card card-info">
          ...
          <td>
            <a href="sliders_editdata/{{$item->id}}" class="btn btn-info"><i class="fas fa-eye"></i></a>
          </td>

          <td>
            <a href="sliders_deletedata/{{$item->id}}" class="btn btn-danger"><i class="fas fa-trash"></i></a>         
          </td>
