...
@section('main-container')
  ...
  <div class="content-wrapper">
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Sliders Add</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
    ...
    <section class="content">
      <form action="sliders_savedata" method="POST" enctype="multipart/form-data">
        @csrf
      <div class="row">
        <div class="col-md-12">
      ...
      <div class="row">
        <div class="col-12">
          ...
          <input type="submit" value="Add new sliders" class="btn btn-success float-right">
        </div>
      </div>
    </form>
