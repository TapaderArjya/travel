      ...
      <div class="container-fluid">
        ...
        <div class="card card-info">
          <div class="card-header">
            <h3 class="card-title">Total Issue Raised</h3>
          ...
          <td>
          <?php
          if($item->admin_remark==3)
          {
            echo "Pending";
          }
          else {
            echo $item->admin_remark;
          }
          ?>
          ...
          <td>
            <a href="{{url('issue_reply',[$item->id])}}"><i><button class="btn btn-warning btn-block">View</button></i><br></a>
            <a href="{{url('delete_issue',[$item->id])}}"><i><button class="btn btn-danger btn-block">Delete</button></i></a>               
          </td>
