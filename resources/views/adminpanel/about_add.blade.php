  ...
  <div class="content-wrapper">
    ...
    <!-- Main content -->
     ...
     <section class="content">
      <form action="about_savedata" method="POST" enctype="multipart/form-data">
        @csrf
      <div class="row">
        <div class="col-md-12">
            ...
            <div class="card-body">
              ...
              <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <textarea id="short_desc" class="form-control" rows="4" name="short_desc"></textarea>
                </div>
      ...
      <div class="row">
        <div class="col-12">
          ...
          <input type="submit" value="Add New About" class="btn btn-success float-right">
        </div>
      </div>
    </form>
